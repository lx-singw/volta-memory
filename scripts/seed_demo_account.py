        ...
        with psycopg.connect(db_url, autocommit=True) as conn:
            with conn.cursor() as cur:
                ...
                cur.execute(
                    ...
                    ) VALUES (%s, %s, %s, %s, %s, %s, 1, 1, %s, %s, %s, 0.85, 'Direct financial context for sizing', 'plausible', 'individual', %s)
                    """,
                ...
                cur.execute(
                    ...
                    INSERT INTO memories (
                        ...
                        source_session_id, importance_score, importance_reasoning,
                        plausibility_flag, source, created_at
                    ) VALUES (%s, %s, %s, %s, %s, %s, 1, 1, %s, %s, %s, 0.95, 'Primary driver of energy system choice', 'plausible', 'individual', %s)
                    """,
                ...
                cur.execute(
                    ...
                    INSERT INTO memories (
                        ...
                        source_session_id, importance_score, importance_reasoning,
                        plausibility_flag, source, created_at
                    ) VALUES (%s, %s, %s, %s, %s, %s, 1, 1, %s, %s, %s, 0.10, 'Irrelevant personal detail', 'plausible', 'individual', %s)
                    """,
                ...
                cur.execute(
                    ...
                    INSERT INTO memories (
                        ...
                        source_session_id, importance_score, importance_reasoning,
                        plausibility_flag, source, created_at
                    ) VALUES (%s, %s, %s, %s, %s, %s, 1, 1, %s, %s, %s, 0.90, 'Updated monthly bill context', 'plausible', 'individual', %s)
                    """,
